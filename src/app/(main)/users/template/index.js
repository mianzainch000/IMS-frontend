  ...
  const handleAdminReset = async () => {
    ...
    try {
      const res = await axios.put(
        `/users/adminResetPassword/${resetModal.userId}`,
        {
          newPassword,
        },
      );
                ...
                <tr key={u._id}>
                  ...
                  <td>
                    <select
                      ...
                      value={u.role}
                      onChange={(e) =>
                        updateUserDetail(u._id, { role: e.target.value })
                      }
                    >
        ...
        <div className={styles.modalOverlay}>
          <div className={styles.modalContent}>
            ...
            <div className={styles.modalActions}>
              ...
              <button className={styles.confirmBtn} onClick={handleAdminReset}>
                Update
              </button>
            </div>
          </div>
