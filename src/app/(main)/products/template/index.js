                                ...
                                <tr key={p._id}>
                                    ...
                                    <td data-label="Actions">
                                        <div className={styles.actionGroup}>
                                            <PermissionWrapper allowedRoles={["Admin", "Editor"]}>                                                <button className={styles.editBtn} onClick={() => handleEditClick(p)}>
                                                <Icons.Edit />
                                            </button>
                                            </PermissionWrapper>

                                            <PermissionWrapper allowedRoles={["Admin",]}>                                                <button className={styles.deleteBtn} onClick={() => handleDeleteClick(p._id)}>
                                                <Icons.Delete />
                                            </button>
                                            </PermissionWrapper>
